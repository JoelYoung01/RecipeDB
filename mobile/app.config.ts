 ...
 * - RECIPEDB_IOS_BUNDLE_ID    — Apple bundle identifier (must match the
 *   provisioning profile used to sign release builds).
 * - RECIPEDB_IOS_BUILD_NUMBER — CFBundleVersion; unique per TestFlight upload.
